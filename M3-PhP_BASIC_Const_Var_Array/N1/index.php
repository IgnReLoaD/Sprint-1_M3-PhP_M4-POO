        ...
        <div id="content" class="flex-vertical">
            ...
            <header class="flex-vertical">
                ...
                <hgroup id="header-inf" >
                    <div id="header-center-inf">  Exercici 1   |   Exercici 2   |   Exercici 3   |   Exercici 4   |   Exercici 5  </div>
                </hgroup>
            </header>        
            ...
            <main class="flex-horizontal">
                <article class="flex-vertical">
                    <section class="art-corto, flex-2-cols">
                        <post class="art-corto"> <?php include 'controllers/exercici_1.php';?> </post>
                        <post class="art-corto"> <?php include 'controllers/exercici_1_b_dump.php';?> </post>
                    </section>
                    <section class="flex-2-cols">
                        <post class="art-corto"> <?php include 'controllers/exercici_2.php';?> </post>
                        <post class="art-corto"> <?php include 'controllers/exercici_3.php';?> </post>
                    </section>
                    <section class="flex-2-cols">
                        <post class="art-corto"> <?php include 'controllers/exercici_4.php';?> </post>
                        <post class="art-corto"> <?php include 'controllers/exercici_5.php';?> </post>
                    </section>
                    <section class="flex-1-col">
                        <post class="art-largo"> <?php include 'controllers/exercici_1_c_unset.php';?> </post>
                    </section>                    
                </article>
